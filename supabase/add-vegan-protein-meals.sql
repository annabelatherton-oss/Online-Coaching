...
-- (not instead of) the bean/chickpea-based vegan meals added earlier, giving the vegan
-- rotation real variety and much higher protein per meal. Same idempotent pattern as every
-- other meal import: guarded by (coach_id, category, name), safe to re-run.
