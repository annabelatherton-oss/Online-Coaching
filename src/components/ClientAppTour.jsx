...
const STEPS = [
  ...
  { kind: 'page', path: '/client/meals', selectors: ['[data-tour="everyday-meals"]', '[data-tour="meals-heading"]'], title: 'Eating the same meals every day', body: "Prefer to have the same meals every day instead of following the plan above? Pick your breakfast, lunch, pre-workout, dinner and evening snack here — they all apply straight away." },
