...
export default function MealsList() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-20 -mx-4 -mt-4 lg:-mx-6 lg:-mt-6 px-4 lg:px-6 pt-4 lg:pt-6 pb-3 bg-white dark:bg-gray-900 border-b border-pink-100 dark:border-gray-800 flex flex-col sm:flex-row gap-3">
