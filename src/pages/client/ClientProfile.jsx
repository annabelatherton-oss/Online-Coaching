...
function DayAvailabilityCard({ clientId, dayPreferences }) {
  ...
  return (
    <div className="card space-y-3">
      <div>
        <h3 className="text-base font-semibold text-gray-900 dark:text-white">Training Availability</h3>
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
          Let your coach know which days you can't train, or which days are already taken by
